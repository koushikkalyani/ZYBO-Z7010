...
HD_PWD='C:/koushik_zybo/johnson_counter/johnson_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log jc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source jc.tcl -notrace
