...
HD_PWD='C:/koushik_zybo/johnson_counter/johnson_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jc.tcl
