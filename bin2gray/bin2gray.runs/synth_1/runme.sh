...
HD_PWD='C:/koushik_zybo/bin2gray/bin2gray.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log b2g.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source b2g.tcl
