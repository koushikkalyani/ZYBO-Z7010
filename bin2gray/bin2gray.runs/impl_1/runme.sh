...
HD_PWD='C:/koushik_zybo/bin2gray/bin2gray.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log b2g.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source b2g.tcl -notrace
